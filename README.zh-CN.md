...
它不是 Stats，也不是活动监视器。没有进程树、没有温度风扇、没有桌面主窗口。点菜单栏图标，结束占满的那个，点外面关掉。
...
Stats / iStat 那种只看传感器的菜单栏、程序坞图标或桌面主窗口、可展开进程树、Mac App Store、沙盒、辅助功能 / 完整磁盘访问、Windows / Linux 客户端。
